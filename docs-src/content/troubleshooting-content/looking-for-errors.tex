...
If no errors are detected please follow the \autoref{sect:ext_err}.
...
\footnotetext[1]{
    Send the complete stack trace of the error with the complete system information as described in \autoref{sect:gatheringinfo}
}