...
public class EventMessageSelectStatement implements SqlStatement
{
  private Collection<SqlParameter> mParameters = new ArrayList<SqlParameter>();

  public EventMessageSelectStatement(final int userId) {
    mParameters.add(new SqlParameter<Integer>(1, "id", userId));
  }

  @Override
  public String sql() {
    return "SELECT * FROM chat.EVENTMESSAGE WHERE USERID=?";
  }

  String table()
  {
    return "chat.EVENTMESSAGE";
  }
