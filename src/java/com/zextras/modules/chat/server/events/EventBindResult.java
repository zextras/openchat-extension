...
public class EventBindResult extends Event
{
  public EventBindResult(EventId eventId, SpecificAddress address) {
    super(eventId, address, new Target());
  }

  public String getResourceString()
  {
    return getSender().resourceAddress();
  }
