...
@Singleton
public class UserEventInterceptorFactoryImpl extends StubEventInterceptorFactory implements UserEventInterceptorFactory
{
  ...
  @Inject
  public UserEventInterceptorFactoryImpl(
