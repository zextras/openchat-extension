...
public class DirectRelationshipStorage
{
  ...
  public void removeRelationship(int userId, SpecificAddress buddy)
  {
    ...
    try
    {
      ...
      newUserMap.remove(buddy.withoutResource());
  ...
  public Relationship get(int userId,SpecificAddress specificAddress)
  {
    ...
    if( buddyMap != null )
    {
      return buddyMap.get(specificAddress.withoutResource());
    }
    else
    {
      return null;
  ...
  public Map<SpecificAddress, Relationship> getMap(int userId)
  {
    HashMap<SpecificAddress, Relationship> buddyMap = mMap.get(userId);
    if( buddyMap != null )
    {
  ...
  {
    Relationship rel = get(userId, specificAddress.withoutResource());
    if( rel == null )
    {
