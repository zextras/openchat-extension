...
public class CommonSessionEventFilter implements EventFilter {
  ...
  @Inject
  public CommonSessionEventFilter(CommonSessionEventInterceptorBuilder commonSessionEventInterceptorBuilder)
  {
