...
public class XmppEventInterceptorFactory extends StubEventInterceptorFactory
{
  private final StanzaProcessor.XmppConnectionHandler mConnectionHandler;

  public XmppEventInterceptorFactory(StanzaProcessor.XmppConnectionHandler connectionHandler) {
